...
export const fetchPatients = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(
      "https://patient-management-one.vercel.app/api/v1/patient",
    );
...
export const addPatientAsync = createAsyncThunk(
  ...
  async (patient) => {
    const response = await axios.post(
      "https://patient-management-one.vercel.app/api/v1/patient/new",
      patient,
    );
...
export const updatePatientAsync = createAsyncThunk(
  ...
  async ({ id, patient }) => {
    const response = await axios.put(
      `https://patient-management-one.vercel.app/api/v1/patient/update/${id}`,
      patient,
    );
    console.log("response", response.data.updatedPatient);
